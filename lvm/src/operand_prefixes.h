...
#define OPERAND_MEMORY_RELATIVE 0xb
#define OPERAND_MEMORY_ABSOLUTE 0xc
...
#define OPERAND_MEMORY_OFFSET_FROM_REGISTER 0xe
#define OPERAND_MEMORY_FROM_REGISTER 0xf
#define OPERAND_HIGHEST_DWORD_CHAR OPERAND_MEMORY_FROM_REGISTER